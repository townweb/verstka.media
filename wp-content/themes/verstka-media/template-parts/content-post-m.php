...
if ($args['format'] == 'code') {
    $html = '
<li class="wp-block-post post-' . $post_id . ' post type-post status-publish post-style-m format-standard has-post-thumbnail hentry category-article">
                    ...
                    <div class="wp-block-group">
                        <div class="is-content-justification-left d-flex wp-block-group post-meta">
                            ...
                            <div style="font-size: var(--wp--custom--font-sizes--x-small);" class="wp-block-post-date">
                                <time datetime="' . $datec . '"><span>' . (calc_publish_date($post)? calc_publish_date($post) : $date  ) . '</span></time>
                            </div>
                        </div>
                    </div>
                </div>
